...
public class Rule8Main {
    
    
    public static void main(String[] args) {
        KieServices kieServices = KieServices.Factory.get();
        KieContainer kieContainer = kieServices.getKieClasspathContainer();
        KieSession kieSession = kieContainer.newKieSession("ksession-rules8");
...
//        kieSession.addEventListener(new LoggingRuleRuntimeEventListener());
//        
        List<BagScannedEvent> events = FactsLoader.loadEvents("events-expires.csv");
