...
public class SupportCase966942 {
...
private static EntityManagerFactory emf;
	...
	public static void main(String[] args) {
        ...
        System.out.println("ksession.getProcessInstances() - " + ksession.getProcessInstances());   
        
        LocalTaskService taskService = getTaskServiceAndRegisterHumanTaskHandler(ksession);
