...
public class SimpleProcessTest {
    ...
    public void simpleProcessTest(){
        ...
        ProcessInstance process = ksession.startProcess("org.jbpm.test.simpleprocess");
    ...
    public StatefulKnowledgeSession createKSession(){
        ...
        kbuilder.add(new ClassPathResource("process/simpleProcess.bpmn"), ResourceType.BPMN2);
