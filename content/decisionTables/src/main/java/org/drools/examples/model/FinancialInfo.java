...
public class FinancialInfo implements Serializable {
	...
	private static final long serialVersionUID = 6300542013354801524L;
	...
	public FinancialInfo(Double eMINMIRatio, Double gMI, Double nMI, Double nMIGMIRatio, Integer cibilScore,
			...
			String isSBISalaryAccount, String modeOfRepayment, Integer loanTenure, Integer noOfXpressCreditTopups,
	...
	public String getIsSBISalaryAccount() {
		return isSBISalaryAccount;
	}

	public void setIsSBISalaryAccount(String isSBISalaryAccount) {
		this.isSBISalaryAccount = isSBISalaryAccount;
	}
