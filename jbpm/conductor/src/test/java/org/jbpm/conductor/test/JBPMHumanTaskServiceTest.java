...
public class JBPMHumanTaskServiceTest {
	...
	public void testDefaultConfiguration() {
		...
		try {
			...
			TaskService service = getTaskService(humanTaskService.getServer());
	...
	@Test
	public void testDefaultTransportConfigurationWithCustom (){
		String host = "localhost";
		String port = "5153";
		Properties parameters = PropertyLoader.getProperties();
		parameters.setProperty("task.persistence.unit", "org.jbpm.task.test");
